      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-7">
            ...
            >
              ...
              <span className="relative inline-block">
                the way it's
                <svg
                  className="absolute w-full h-3 -bottom-1 left-0 text-[#C8623E] opacity-70"
                  viewBox="0 0 100 10"
            ...
            <p className="text-lg text-[#52504B] leading-relaxed max-w-md font-light">
              Stop drilling textbook grammar. Absorb real phrases, slang, and
              cultural context from hand-picked YouTube clips with native
              speakers.
            </p>
            ...
            <div className="flex items-center gap-4 pt-4 text-sm text-[#6B6660] font-medium">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full border-2 border-[#F8F6F2] bg-[#E8E5DF] overflow-hidden"
                  >
                    <img
                      src={`https://api.dicebear.com/7.x/notionists/svg?seed=${i}&backgroundColor=E8E5DF`}
                      alt="user"
        ...
        <section className="py-20 border-t border-[#E8E5DF]">
          <div className="text-center max-w-2xl mx-auto mb-14 space-y-3">
            ...
            <p className="text-[#52504B] text-base">
              We take real cultural moments and break them down so you
              understand the nuance, not just the vocabulary.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-start max-w-5xl mx-auto">
              ...
              <div className="flex items-center justify-between px-5 py-3 border-b border-[#E8E5DF]">
                <div className="flex items-center gap-2">
                  ...
                  {["Idioms", "Business"].map((tag) => (
                    <span
                      key={tag}
                      className="text-[10px] font-bold px-2 py-0.5 rounded bg-violet-200 text-[#1C1917] border border-[#1C1917] shadow-[1px_1px_0_#1C1917]"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex items-center gap-3">
                  <button className="text-[#A09890] hover:text-[#1C1917] transition-colors">
              ...
              <div className="p-5">
                ...
                {activeTab === "transcript" ? (
                  <div className="space-y-4">
                    <div>
                      <span className="text-[9px] font-bold text-[#A09890] uppercase tracking-wider block mb-0.5">
                        Speaker 1
                      </span>
                      <p className="text-sm text-[#6B6660] leading-relaxed font-light">
                        So we've been going back and forth on these mockups for
                        weeks now. I mean, I love the direction, but we're
                        running out of time.
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#6B6660] leading-relaxed font-light">
                        I{" "}
                        <span className="border-b border-dashed border-[#A09890] hover:border-[#1C1917] hover:text-[#1C1917] cursor-pointer transition-colors">
                          reckon
                        </span>{" "}
                        we can, if engineering gets the staging environment
                        stable today.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 text-[#52504B]">
                    <div className="p-4 bg-amber-50 rounded-xl border border-amber-200">
                      ...
                      <p className="text-sm leading-relaxed">
                        In American business culture, saying "let's cut to the
                        chase" is acceptable when time is short, but it can
                        sound abrupt. It's usually softened with "Yeah, I agree"
                        or used among equals.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <div className="bg-[#1C1917] rounded-2xl p-6 text-white">
                <span
                  className="text-[#C8623E] text-xs font-bold uppercase tracking-widest mb-2 block"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                  Key phrase
                </span>
                ...
                <p className="text-white/70 text-sm leading-relaxed mb-5 border-l-2 border-[#C8623E] pl-3">
                  Originates from early silent films, when boring dialogue
                  scenes would cut to an exciting chase scene.
                </p>
                <div className="bg-white/5 rounded-xl p-3 text-sm mb-5 border border-white/10">
                  ...
                  <span className="text-white/60 italic text-xs">
                    "We only have 5 minutes, so let's cut to the chase."
                  </span>
                </div>
              ...
              <div className="bg-white border border-[#DDD9D2] rounded-2xl p-5">
                <h4 className="font-semibold text-[#1C1917] mb-4 text-sm">
                  Today's Progress
                </h4>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#A09890] mt-0.5">
                      2 more phrases to reach your daily goal.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {[
              {
                ...
                desc: "Train your ear to catch linked words, dropped sounds, and natural pacing that textbooks ignore.",
              },
              {
                icon: BookOpen,
                title: "Cultural Context",
                desc: "Language is culture. Understand the humor, politeness levels, and unspoken rules behind the words.",
              },
              {
                icon: RotateCcw,
                title: "Spaced Repetition",
                desc: "Save phrases you want to use. We'll remind you to review them just before you're likely to forget.",
              },
            ].map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="bg-white border border-[#DDD9D2] rounded-2xl p-7"
              >
        ...
        <section className="py-16 mb-12 rounded-2xl bg-[#1C1917] text-center px-8">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-[#A09890] text-base mb-9 max-w-lg mx-auto font-light">
              Join thousands of learners who have ditched the textbook to learn
            ...
            <p className="mt-5 text-xs text-[#6B6660]">
