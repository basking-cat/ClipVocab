    ...
    <AppShell activePage="review">
      <div className="max-w-xl mx-auto px-4 sm:px-6 py-6 sm:py-9">
        ...
        <div className="mb-6 sm:mb-7 text-center">
          <h1 className="text-2xl sm:text-3xl font-bold text-[#1C1917] mb-5 tracking-tight" style={{ fontFamily: 'Playfair Display, serif' }}>Daily Review</h1>
        ...
        <div className="space-y-4">
          ...
          {/* AI Feedback */}
          {phase === 'ai_feedback' && (
            <div className={`rounded-2xl border-2 border-[#1C1917] p-4 sm:p-5 ${scoreBg} ${scoreText} shadow-[4px_4px_0_#1C1917]`}>
